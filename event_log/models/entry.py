...
class Entry(models.Model):
    ...
    cosplayer = models.ForeignKey('shoottikala.Cosplayer', **TARGET_FKEY_ATTRS)
    photographer = models.ForeignKey('shoottikala.Photographer', **TARGET_FKEY_ATTRS)
    ...
    def email_subject(self):
        return '[{app_name}] {message}'.format(
            app_name=settings.SHOOTTIKALA_APPLICATION_NAME,
